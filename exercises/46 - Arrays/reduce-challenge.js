...
function isValidCharacter(character) {
  // if that character is a-z or 0-9, then we keep it
...
function instanceCounter(totalCount, character) {
  if (totalCount[character]) {
    totalCount[character] = totalCount[character] + 1;
  } else {
...
function sortByValue(first, second) {
...
const sortedTextArray = Object.entries(textArray).sort(sortByValue);
